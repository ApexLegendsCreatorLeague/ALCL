-- Add role flags on profiles for Supabase Table Editor visibility.
-- Source of truth remains profile_roles; these columns stay in sync via trigger.
--
--   is_player  → player role (teams, dashboard, registration)
--   is_admin   → admin role (platform administration)
--   is_owner   → organizer role (full league / site owner access)
