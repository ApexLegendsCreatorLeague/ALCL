...
-- Lets players publish recruitment info captains use when drafting.
...
select
  exists (
    ...
    where table_schema = 'public' and table_name = 'profiles' and column_name = 'recruitment_pitch'
  ) as has_recruitment_pitch;
