  ...
  return (
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        <header><div><p className="eyebrow">{admin ? "ORGANIZER WORKSPACE" : "COMPETITOR WORKSPACE"}</p><h1>{title}</h1><p>{description}</p></div><span className="demo-pill">DEMO MODE</span></header>
        {children}
      </main>
    </div>
  );
